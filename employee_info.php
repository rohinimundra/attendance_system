...
<button class="button button3"><a style="color:#FFF;" href="set_attendance.php">Attendance</a></button>
<br><br>
<p style="font-size:22px; color:#000; font-weight:bold;">Self Employee Details :</p><br>
...
<div>
     <?php
            ...
            ?> 
   <form method="post" action="savemp.php">
    <label for="fname">Employee Name</label>
    <input type="text" id="fname" name="tx1" placeholder="Your name.." value="<?php echo $empname1.' '.$empname2; ?>" disabled  required>
    
    <label for="country">Designation</label>
    <select id="country" name="tx3" required disabled>
        <option value="<?php echo $name; ?>"><?php echo $name; ?></option>
    </select>
    
    <label for="lname">Employee Address</label>
    <textarea type="text" name="tx4" required disabled><?php echo trim($location); ?></textarea>
    
    <label for="country">Age</label>
    <input type="text" id="lname" name="tx6" placeholder="Your Age.." value="<?php echo $age; ?>" disabled required>
    
     <label for="lname">Salary</label>
    <input type="text" id="lname" name="tx7" value="<?php echo $sal; ?>" disabled   required>
    
     <label for="lname">Date of Joining</label>
    <input type="date" id="lname" name="tx8" value="<?php echo $duration; ?>" disabled  required>
    
     <label for="lname">Contact</label>
    <input type="text" id="lname" name="tx9" value="<?php echo $ph; ?>" disabled  placeholder="Your Contact Details.." required>
