...
<button class="button button2"><a style="color:#FFF;" href="view_attendence.php">View Attendence</a></button>
...
<br>
 ...
 <?php
                        /*GET ALL EMPLOYEES*/
                        $sql="SELECT a.empid,a.day,a.status,e.fname,e.lname,e.designation FROM attendance a JOIN employee e ON a.empid=e.eid ORDER BY a.day DESC";
                           $rs=mysql_query($sql);
                            $i=0;
							$sl=0;
    ...
    <tr> 
      ...
      <td data-label="Period"><?php echo $dy; ?></td>
        <td class="inp_data"> <img src='img/up.png' class='yes' alt='Present'/></td>
