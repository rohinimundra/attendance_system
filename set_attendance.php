...
<script>
    function setA(empnum)
    {
       
        
	if (confirm('DO YOU WANNA TO GIVE ATTENDANCE FOR THE DAY ? ')) {
             var values=0;
        if (document.getElementById('rd1').checked == true)
        {
          ...
          $.ajax({
                ...
                type: "POST",
                url: "aday.php",
                data: 'empnum='+empnum+"&sts="+values,  
                datatype: "html",
                success: function(result)
                        {
                               if(result==1)
                               {
                              window.location.href='set_attendance.php?emsg=1';
                               }else
                               {
                                alert('Sorry,can not ATTENDANCE add!!!!!');
                               }
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        ...
                        <button class="button button1"><a style="color:#FFF;" href="employee.php">Dashboard</a></button>
<button class="button button2"><a style="color:#FFF;" href="employee_info.php">View Employee</a></button>
<button class="button button3"><a style="color:#FFF;" href="set_attendance.php">Attendance</a></button><br><br>
 <?php
        $ms="";
        if(isset($_GET['emsg']))
        {
            ...
            if($ms==1)
            {
                echo "<h2 style='color:#6af;padding:7px;border:1px dashed #f66;'>  Attendance Accepted Successfully by System for ".date('d-m-Y').". <br/> Have a good Day </h2>";
            }else
            {
                 echo "<h2 style='color:#f55;padding:7px;border:1px dashed #f66;'> Sorry, attendance can not save. Try again </h2>";
            }
...
<br>
  ...
  <thead>
    <tr>
      ...
      <th scope="col"> <input type="text" id="fname" name="tx1" placeholder="Your name.."  value="<?php echo $empname1.' '.$empname2; ?>" disabled  required></th>
      
    </tr>
     <tr> 
      <td data-label="Attendance">Attendance Date (dd-mm-yyyy):</td>
      <td data-label=""><?php echo date('d-m-Y'); ?></td>
    </tr>
  </thead>
  <tbody>
    ...
    <tr> 
      <td data-label=""></td>
      <td data-label="Attendance"><input type="radio" value="1" name="r1" id='rd1' /><span style="color:#6af;"> Present </span>&nbsp;&nbsp;&nbsp; || &nbsp;&nbsp;&nbsp; 
                                         <input type="radio" value="2" name="r1" id='rd2' />  <span style="color:#f22;">  Absent </span></td>
    </tr>
      <tr> 
      <td data-label=""></td>
      <td data-label="Submit"> <input type="SUBMIT" value="Submit" onclick="setA('<?php  echo $empid; ?>');" name="b1" />
                                            <input type="RESET" style="margin-left:15px;" value="CLEAR" name="b2" /></td>
    </tr>
