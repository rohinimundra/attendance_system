            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4 col-lg-4 col-sm-6">
                        ...
                        <a href="employee_details.php"><img src="img/Recruitment.jpg"></a>
                          <div class="service_title">
                              <i class="fa fa-dropbox"></i>
                            <h4><a href="employee_details.php">Employee Details</a></h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-4 col-sm-6">
                        <div class="single_service">
                            <a href="view_attendence.php"><img src="img/software.jpg" alt=""></a>
                            <div class="service_title">
                                <i class="fa fa-dropbox"></i>
                                <h4><a href="view_attendence.php">Attendance Details</a></h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-4 col-sm-6">
                        <div class="single_service">
                            <a href="set_password.php"><img src="img/SER.jpg" alt=""></a>
                            <div class="service_title">
                                <i class="fa fa-dropbox"></i>
                                <h4><a href="set_password.php">Setting Information</a></h4>
                            </div>
                        </div>
                    </div>
