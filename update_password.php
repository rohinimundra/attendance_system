...
function changepass()
{
    var ps1=document.getElementById('txtpass').value;
    var eid=document.getElementById('empid').value;
    
     var dataString = 'pass='+ ps1+"&empid="+eid ;
...
<button class="button button2"><a style="color:#FFF;" href="update_password.php">Set Password</a></button>
...
<br>
 ...
 <?php 
    ...
    <tr> 
      ...
      <td data-label="Due Date"><?php echo $username; ?></td>
      <td data-label="Period"><input type="text" id='txtpass' name='txtp1' value="<?php echo $password; ?>" required disabled/></td>
      
      
      <input type='HIDDEN' id='empid' name='employeeid' value="<?php echo $username; ?>" />
      <td class="inp_data cen"><input type="button" id="passbtn" onclick="" name="btnpass" value="Use This Password"/></td>
      ...
      <?php
                                ...
                                <p style="font-size:24px; color:#F00;">Password Changed successfully.</p><br>
                                </div>
