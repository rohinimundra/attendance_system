...
<div align="">
   ...
   <form method="post" action="savemp.php">
    ...
    <input type="text" id="fname" name="tx1" placeholder="Your name.." required>

    <label for="lname">Employee Last Name</label>
    <input type="text" id="lname" name="tx2" placeholder="Your last name.." required>
    
    <label for="country">Designation</label>
    <select id="country" name="tx3" required>
    ...
    <textarea type="text" name="tx4" required></textarea>
    
    <label for="lname">Gender</label>
      <select id="country" name="tx5" required>
      <option value="Male">Male</option>
      <option value="Female">Female</option>
      </select>

    <label for="country">Age</label>
    <input type="text" id="lname" name="tx6" placeholder="Your Age.." required>
    
     <label for="lname">Salary</label>
    <input type="text" id="lname" name="tx7" required>
    
     <label for="lname">Date of Joining</label>
    <input type="date" id="lname" name="tx8" required>
    
     <label for="lname">Contact</label>
    <input type="text" id="lname" name="tx9" placeholder="Your Contact Details.." required>
